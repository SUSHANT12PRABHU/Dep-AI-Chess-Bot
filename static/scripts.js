...
var getResponseMove = function() {
    ...
    $.get($SCRIPT_ROOT + "/move/" + depth + "/" + fen, function(data) {
        ...
        // The animations would stutter when moves were returned too quick, so I added a 150ms delay before the animation
        setTimeout(function(){ board.position(game.fen()); }, 150);
    })
}
